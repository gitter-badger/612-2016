...
std::shared_ptr<CANTalon> RobotMap::shooterAim;
...
void RobotMap::init()
{
	...
	shooterLeftFlywheel.reset(new CANTalon(4));
	lw->AddActuator("Shooter", "LeftFlywheel", shooterLeftFlywheel);

	shooterRightFlywheel.reset(new CANTalon(5));
	lw->AddActuator("Shooter", "RightFlywheel", shooterRightFlywheel);

	shooterAim.reset(new CANTalon(6));
	lw->AddActuator("Shooter", "RightFlywheel", shooterRightFlywheel);
